...
def setup(chip):
    ...
    for tool in ('openroad', 'klayout', 'magic'):
        chip.set('pdk', process,'aprtech',tool,stackup, 'unithd','lef',
                pdkdir+'/apr/sky130_fd_sc_hd.tlef')
        chip.set('pdk', process,'aprtech',tool,stackup, 'unit','lef',
                pdkdir+'/apr/sky130_fd_sc_hs.tlef')

    # Openroad specific files
    chip.set('pdk', process, 'aprtech','openroad', stackup, 'unithd','tapcells',
            pdkdir+'/apr/tapcell_hd.tcl')
    chip.set('pdk', process, 'aprtech','openroad', stackup, 'unit','tapcells',
    ...
    if (libtype == 'unithd'):
        chip.set('pdk', process, 'layermap', 'klayout', 'def', 'gds', stackup, pdkdir+'/setup/klayout/sky130hd.lyt')
    elif (libtype == 'unit'):
