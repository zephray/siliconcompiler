...
def make_docs():
    '''
    The 'skywater130b' Open Source PDK is a collaboration between Google and
    ...
    * https://github.com/google/skywater-pdk
    ...
    chip = siliconcompiler.Chip('skywater130bhs')
    setup(chip)
...
def setup(chip):
    '''
    Setup function for the skywater130b PDK with HS library.
    '''
    ...
    for tool in ('openroad', 'klayout', 'magic'):
        chip.set('pdk', process,'aprtech',tool,stackup, libtype,'lef',
                pdkdir+'/apr/sky130_fd_sc_hs.tlef')

    # Openroad specific files
    chip.set('pdk', process, 'aprtech','openroad', stackup, libtype,'tapcells',
            pdkdir+'/apr/tapcell_hs.tcl')

    # DRC Runsets
    chip.set('pdk', process,'drc', 'runset', 'magic', stackup, 'basic', pdkdir+'/setup/magic/sky130B.tech')

    # LVS Runsets
    chip.set('pdk', process,'lvs', 'runset', 'netgen', stackup, 'basic', pdkdir+'/setup/netgen/lvs_setup.tcl')

    # Layer map and display file
    chip.set('pdk', process, 'layermap', 'klayout', 'def', 'gds', stackup, pdkdir+'/setup/klayout/sky130hs.lyt')

    chip.set('pdk', process, 'display', 'klayout', stackup, pdkdir+'/setup/klayout/sky130B.lyp')
    ...
    chip.set('pdk', process, 'grid', stackup, 'li1', 'xoffset', 0.24)
    chip.set('pdk', process, 'grid', stackup, 'li1', 'xpitch',  0.48)
    chip.set('pdk', process, 'grid', stackup, 'li1', 'yoffset', 0.185)
    chip.set('pdk', process, 'grid', stackup, 'li1', 'ypitch',  0.37)
    chip.set('pdk', process, 'grid', stackup, 'li1', 'adj', 1.0)

    chip.set('pdk', process, 'grid', stackup, 'met1', 'name', 'm1')
    chip.set('pdk', process, 'grid', stackup, 'met1', 'xoffset', 0.185)
    chip.set('pdk', process, 'grid', stackup, 'met1', 'xpitch',  0.37)
    chip.set('pdk', process, 'grid', stackup, 'met1', 'yoffset', 0.185)
    chip.set('pdk', process, 'grid', stackup, 'met1', 'ypitch',  0.37)
    chip.set('pdk', process, 'grid', stackup, 'met1', 'adj', 0.5)

    chip.set('pdk', process, 'grid', stackup, 'met2', 'name', 'm2')
    chip.set('pdk', process, 'grid', stackup, 'met2', 'xoffset', 0.24)
    chip.set('pdk', process, 'grid', stackup, 'met2', 'xpitch',  0.48)
    chip.set('pdk', process, 'grid', stackup, 'met2', 'yoffset', 0.24)
    chip.set('pdk', process, 'grid', stackup, 'met2', 'ypitch',  0.48)
    chip.set('pdk', process, 'grid', stackup, 'met2', 'adj', 0.5)

    chip.set('pdk', process, 'grid', stackup, 'met3', 'name', 'm3')
    chip.set('pdk', process, 'grid', stackup, 'met3', 'xoffset', 0.37)
    chip.set('pdk', process, 'grid', stackup, 'met3', 'xpitch',  0.74)
    chip.set('pdk', process, 'grid', stackup, 'met3', 'yoffset', 0.37)
    chip.set('pdk', process, 'grid', stackup, 'met3', 'ypitch',  0.74)
    chip.set('pdk', process, 'grid', stackup, 'met3', 'adj', 0.5)

    chip.set('pdk', process, 'grid', stackup, 'met4', 'name', 'm4')
    chip.set('pdk', process, 'grid', stackup, 'met4', 'xoffset', 0.48)
    chip.set('pdk', process, 'grid', stackup, 'met4', 'xpitch',  0.96)
    chip.set('pdk', process, 'grid', stackup, 'met4', 'yoffset', 0.48)
    chip.set('pdk', process, 'grid', stackup, 'met4', 'ypitch',  0.96)
    chip.set('pdk', process, 'grid', stackup, 'met4', 'adj', 0.5)

    chip.set('pdk', process, 'grid', stackup, 'met5', 'name', 'm5')
    chip.set('pdk', process, 'grid', stackup, 'met5', 'xoffset', 1.85)
    chip.set('pdk', process, 'grid', stackup, 'met5', 'xpitch',  3.33)
    chip.set('pdk', process, 'grid', stackup, 'met5', 'yoffset', 1.85)
    chip.set('pdk', process, 'grid', stackup, 'met5', 'ypitch',  3.33)
...
if __name__ == "__main__":
    ...
    chip = make_docs()
    chip.write_manifest('skywater130b.tcl')
