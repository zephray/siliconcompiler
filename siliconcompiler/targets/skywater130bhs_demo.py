...
def setup(chip):
    '''
    Skywater130B_HS Demo Target
    '''

    #0. Defining the project
    project = 'skywater130bhs_demo'
    ...
    chip.set('asic', 'maxslew', 1.5e-9) # TODO
    chip.set('asic', 'maxcap', .1532e-12) # TODO
